          ...
          <div className="hello-world-expandable-card">
            ...
            {expandedItemDetails && (
              <div className="hello-world-expand-content">
                ...
                <div className="hello-world-detail-row">
                  <Tooltip content="The type of Fabric item in the format [WorkloadName].[ItemName] (e.g., Org.MyWorkload.SalesForecast)" relationship="label">
                ...
                <div className="hello-world-detail-row">
                  <Tooltip content="The definition is stored as part of the item in Fabric. SalesForecast uses a message to demonstrate the behaviour." relationship="label">
        ...
        <div className="hello-world-resources-section">
          <div className="hello-world-cards-grid">
            ...
            <Card className="hello-world-resource-card">
              <div className="hello-world-card-header-section">
                <div className="hello-world-card-image-container">
                  <img src="/assets/items/SalesForecastItem/card_1.svg" alt="Getting started" className="hello-world-card-image" />
                </div>
                <CardHeader
            ...
            <Card className="hello-world-resource-card">
              <div className="hello-world-card-header-section">
                <div className="hello-world-card-image-container">
                  <img src="/assets/items/SalesForecastItem/card_2.svg" alt="Playground" className="hello-world-card-image" />
                </div>
                <CardHeader
            ...
            <Card className="hello-world-resource-card">
              <div className="hello-world-card-header-section">
                <div className="hello-world-card-image-container">
                  <img src="/assets/items/SalesForecastItem/card_3.svg" alt="Fabric UX" className="hello-world-card-image" />
                </div>
                <CardHeader
